...
import com.anialopata.model.JwtCustomerDetails;
...
public class JwtAuthenticationProvider extends AbstractUserDetailsAuthenticationProvider {
    ...
    protected UserDetails retrieveUser(String username, UsernamePasswordAuthenticationToken usernamePasswordAuthenticationToken) throws AuthenticationException {
        ...
        Customer jwtUser = validator.validate(token);
        ...
        return new JwtCustomerDetails(jwtUser.getFirstName(), jwtUser.getLastName(), jwtUser.getUsername(), jwtUser.getPhoneNumber(), jwtUser.getId(), token, grantedAuthorities);
    }
